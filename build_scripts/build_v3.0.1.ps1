# Build ShareJadPi v3.0.1 executable
# Run this script to create a standalone .exe file

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Building ShareJadPi v3.0.1" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
pyinstaller --clean ShareJadPi-3.0.1.spec

# Check if build was successful
if (Test-Path "dist\ShareJadPi-3.0.1.exe") {
    Write-Host ""
    ...
    $exePath = Resolve-Path "dist\ShareJadPi-3.0.1.exe"
    Write-Host "  $exePath" -ForegroundColor White
    Write-Host ""
    $size = (Get-Item "dist\ShareJadPi-3.0.1.exe").Length / 1MB
    ...
    Write-Host "  .\dist\ShareJadPi-3.0.1.exe" -ForegroundColor White
    Write-Host ""
} else {
    Write-Host ""
